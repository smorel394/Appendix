...
\lean{CategoryTheory.mono_map_of_mono_and_acyclicCokernel}
\leanok 
\uses{def-hTh, def-acyclic}
...
\lean{CategoryTheory.epi_map_of_epi_and_acyclicKernel}
\leanok 
\uses{def-hTh, def-acyclic}
...
\lean{CategoryTheory.Functor.leftAcyclic_ker_of_bounded_complex}
\leanok 
\uses{def-hTh, def-acyclic}
Let $S$ be a cochain complex in $\Df^\heart$, and let $k\in\Z$. 
