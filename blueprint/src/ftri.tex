...
% Proposition A.1.3.1.
\label{def-truncLE}
\lean{CategoryTheory.Functor.truncLE}
\leanok
...
% Proposition A.1.3.1.
\label{def-truncLEπ}
\lean{CategoryTheory.Functor.truncLEπ}
\leanok
\uses{{def-truncLE}}
...
% Proposition A.1.3.1.
\label{def-truncGE}
\lean{CategoryTheory.Functor.truncGE}
\leanok
...
% Proposition A.1.3.1.
\label{def-truncGEι}
\lean{CategoryTheory.Functor.truncGEι}
\leanok
\uses{def-truncGE}
...
\lean{CategoryTheory.FilteredTriangulated.LEGEToGELE}
\leanok
...
\lean{CategoryTheory.FilteredTriangulated.LEGEIsoGELE}
\leanok
\uses{def-LEGEToGELE}
...
\lean{CategoryTheory.FilteredTriangulated.LEGEToGELE_uniq}
\leanok
\uses{def-LEGEToGELE}
...
\lean{CategoryTheory.FilteredTriangulated.Gr-commShift}
\uses{def-Gr}
