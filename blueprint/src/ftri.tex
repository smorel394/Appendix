...
%\[\xymatrix{T(X)\ar[r]^-{\alpha'_{T(X)}}\ar[rd]_-{T(\alpha(X))} & s'(T(X))\ar[d]^\wr \\
%& T(s(X))}\]
...
%\[\xymatrix@C=10pt{\sigma_{\geq b}\ar[rr]\ar[rd] & & \id_{\DF}\ar[rr] & & \sigma_{\leq a} \\
% & \sigma_{\leq a}\sigma_{\geq b}\ar[rr]_-\sim && \sigma_{\geq b}\sigma_{\leq a}\ar[ru] &
%}\]
...
%\[\xymatrix{\DF\ar[r]^-{FT}\ar[d]_\omega&\DF'\ar[d]^\omega \\
%\Df\ar[r]_-T& \Df'}\quad
%\xymatrix{\DF\ar[r]^-{FT}
%\ar[d]_{\Gra^n}&\DF'\ar[d]^{\Gra^n}\\ \Df\ar[r]_-T&\Df'}\quad
%\xymatrix{\DF\ar[r]^-{FT}
%\ar[d]_{\sigma_{\leq n}}&\DF'\ar[d]^{\sigma_{\leq n}}\\ \DF\ar[r]_-{FT}&\DF'}\]
